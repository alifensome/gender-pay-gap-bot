...
describe("dataImporter", () => {
  ...
  it.each([
    ...
    [
      () => dataImporter.companiesGpgDataTest(),
      "./data/companies_GPG_Data-test.json",
    ],
    [
      () => dataImporter.successfulTweets(),
      "./data/tweets/successful-tweets.json",
    ],
    [
      () => dataImporter.twitterUserDataProd(),
      "./data/twitterAccountData/twitterUserData-prod.json",
    ],
    [
      () => dataImporter.twitterUserDataTest(),
      "./data/twitterAccountData/twitterUserData-test.json",
    ],
    [
      () => dataImporter.allTimeLineTweets(),
      "./data/tweets/allTimeLineTweets.json",
    ],
    [
      () => dataImporter.successfulTweetsWithCompanyData(),
      "./data/tweets/successfulTweetsWithCompanyData.json",
    ],
    [
      () => dataImporter.unsuccessfulTweets(),
      "./data/tweets/unsuccessful-tweets.json",
    ],
