...
const getMostRecentGPG_1 = require("./getMostRecentGPG");
describe("isNumber", () => {
    it.each([
        [1, true],
        [0, true],
        ...
        const result = (0, getMostRecentGPG_1.isNumber)(numberOrUndefined);
...
describe("getMostRecentMedianGPG", () => {
    it.each([
        ...
        const result = (0, getMostRecentGPG_1.getMostRecentMedianGPG)(company);
        expect(result).toBe(expectedResult);
    });
});
describe("getMostRecentGPG", () => {
    it.each([
        ...
        const result = (0, getMostRecentGPG_1.getMostRecentGPG)(company);
        expect(result).toBe(expectedResult);
    });
});
//# sourceMappingURL=getMostRecentGPG.test.js.map