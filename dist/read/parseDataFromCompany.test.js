...
describe("parseDataFromJson", () => {
    it("should parse the spreadsheet data", () => {
        ...
        const result = (0, parseDataFromCompany_1.parseDataFromJson)(data);
    ...
    it("should parse nothing to be nothing", () => {
        const result = (0, parseDataFromCompany_1.parseDataFromJson)([{}, { someRandomStuff: "" }]);
        expect(result).toEqual([]);
    });
});
//# sourceMappingURL=parseDataFromCompany.test.js.map