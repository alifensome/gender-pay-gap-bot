...
describe("Repository", () => {
    ...
    const repo = new Repository_1.Repository(mockDataImporter);
    ...
    describe("getNextCompanyWithData", () => {
        ...
        const getNextCompanyWithDataRepo = new Repository_1.Repository(getNextCompanyWithDataMockDataImporter);
        ...
        describe("getNextMatchingCompanyWithData", () => {
            ...
            const getNextMatchingCompanyWithDataRepo = new Repository_1.Repository(mockDataImporter);
            it("should match a company", () => {
                const matcher = (c) => {
                    return (0, companySizeUtils_1.companySizeCategoryToMinSize)(c.size) >= 1000;
                };
            ...
            it("should return null if theres no matches", () => {
                const matcher = (c) => {
                    return (0, companySizeUtils_1.companySizeCategoryToMinSize)(c.size) >= 100000;
                };
                const result = getNextMatchingCompanyWithDataRepo.getNextMatchingCompanyWithData("B", "02", matcher);
